...
cdef extern from "c/orderbook_types.h":
    ...
    ctypedef struct OrderbookLevels:
        u64 num_levels
        OrderbookLevel* levels

cdef OrderbookLevel create_orderbook_level(double price, double size, u64 norders=*) noexcept nogil
cdef OrderbookEntry create_orderbook_entry(u64 ticks, u64 lots, u64 norders=*) noexcept nogil
