...
class NumericRingBuffer(Generic[T]):
    ...
    def insert_batch(self, items: np.ndarray) -> bool: ...
...
def _contains_u64(ringbuffer: NumericRingBuffer[Any], item: int) -> bool: ...
def _insert_u64(ringbuffer: NumericRingBuffer[Any], item: int) -> None: ...
