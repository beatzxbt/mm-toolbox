/**
 * @file munit.h
 * @brief µnit testing framework public header (third-party).
 *
 * Declares test runner API, assertion macros, PRNG, and suite structures.
 * Included here unmodified for the orderbook C test suite.
 *
