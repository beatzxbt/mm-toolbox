/**
 * @file munit.c
 * @brief µnit testing framework implementation (third-party).
 *
 * Provides test runner, assertion macros, PRNG, timing, and parameterised
 * test support. Included here unmodified for the orderbook C test suite.
 *
