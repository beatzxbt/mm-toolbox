...
class TestMultiCandles(unittest.TestCase):
    ...
    def test_update_with_max_duration(self):
        ...
        self.candles.process_trade(
            time=self.dummy_ms + 1000,
            is_buy=False,
            px=111.0,
            sz=25.0
        )
        self.candles.process_trade(
            time=self.dummy_ms + 2000,
            is_buy=True,
            px=112.0,
            sz=20.0
        )
    ...
    def test_update_with_max_volume(self):
        ...
        self.candles.process_trade(
            time=self.dummy_ms + 100,
            is_buy=False,
            px=111.0,
            sz=25.0
        )
        self.candles.process_trade(
            time=self.dummy_ms + 200,
            is_buy=True,
            px=112.0,
            sz=50.0
        )
    ...
    def test_combined_triggers(self):
        ...
        self.candles.process_trade(
            time=self.dummy_ms + 100.0,
            is_buy=False,
            px=111.0,
            sz=20.0
        )
        self.candles.process_trade(
            time=self.dummy_ms + 200.0,
            is_buy=True,
            px=112.0,
            sz=25.0
        )
