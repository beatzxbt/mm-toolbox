...
class TestBaseCandles(unittest.TestCase):
    ...
    def test_rsi(self):
        ...
        close_prices = np.array([104, 103, 107, 109, 108, 106, 103, 101, 99, 98, 97, 96, 95], dtype=np.float64)
        ...
        expected_rsi_values = np.array([0.0, 80.0, 85.714, 75.0, 54.545, 44.444, 36.09, 32.296, 28.545, 24.926, 21.516, 50.0])
    ...
    def test_bollinger_bands(self):
        ...
        open_prices = np.array([100, 102, 104, 106, 105, 103, 101, 100, 98, 97, 96, 95, 94], dtype=np.float64)
        high_prices = np.array([105, 106, 108, 110, 109, 107, 104, 103, 101, 100, 99, 98, 97], dtype=np.float64)
        low_prices = np.array([99, 100, 102, 104, 103, 101, 99, 98, 96, 95, 94, 93, 92], dtype=np.float64)
        close_prices = np.array([104, 105, 107, 109, 108, 106, 103, 101, 99, 98, 97, 96, 95], dtype=np.float64)
        ...
        expected_lower_band = np.array([102.482, 99.387, 96.876, 95.659, 95.292, 94.759, 94.172])
        expected_upper_band = np.array([110.718, 111.413, 109.924, 107.141, 103.908, 101.641, 99.828])
